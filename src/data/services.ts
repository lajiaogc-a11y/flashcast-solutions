...
export const servicesData: ServiceItem[] = [
  ...
  },
  {
    ...
    slug: "old-house",
    summary: "Comprehensive renovation for aging terrace houses, bungalows, and semi-detached homes — from structural repair and rewiring to full interior makeover. Breathe new life into your old property.",
    description: "Many Malaysian homeowners inherit or purchase older properties that need major upgrading. Our Old House Renovation service handles the unique challenges of aging buildings — cracked walls, outdated wiring, old plumbing, termite damage, roof leaks, and worn-out interiors.\n\nWe assess the structural condition of your property and create a renovation plan that addresses both safety concerns and aesthetic goals. From foundation repair and waterproofing to complete interior redesign, we transform aging houses into modern, comfortable homes while preserving any heritage features you want to keep.\n\nOur team has extensive experience with Malaysian terrace houses, semi-detached homes, and bungalows built in the 1970s-1990s — we understand the common issues and know how to solve them efficiently.",
    suitableFor: [
      "Owners of terrace houses built before 2000",
      "Inherited property needing major renovation",
      "Property investors upgrading old units for rental or resale",
      "Families wanting to modernize their family home",
      "Buyers of subsale properties needing full overhaul",
    ],
    commonProjects: [
      "Full terrace house renovation",
      "Bungalow modernization",
      "Semi-D interior overhaul",
      "Kitchen and bathroom replacement",
      "Roof repair and waterproofing",
      "Complete rewiring and replumbing",
    ],
    processSteps: [
      { title: "Structural Assessment", desc: "We inspect the property for structural issues, termite damage, water damage, and electrical/plumbing condition." },
      { title: "Renovation Plan", desc: "We create a detailed renovation plan addressing both structural repairs and interior design upgrades." },
      { title: "Cost Estimation", desc: "Transparent itemized quotation covering all repair works, materials, and finishing." },
      { title: "Demolition & Repair", desc: "We handle all demolition, structural repairs, waterproofing, rewiring, and replumbing." },
      { title: "Interior Fit-Out", desc: "New flooring, ceiling, painting, built-in furniture, kitchen, bathroom, and all finishing works." },
      { title: "Final Handover", desc: "Complete inspection, defect rectification, cleaning, and warranty handover." },
    ],
    items: [
